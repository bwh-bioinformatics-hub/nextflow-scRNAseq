...
so_postfilter <- subset(x = so_postfilter, 
...
ggarrange(prefilter_qc_mito,postfilter_qc_mito,ncol=1,nrow=2,widths = 10,heights = 8)
```
...
ggarrange(genes_detected_per_umi_pre,genes_detected_per_umi_post,ncol=1,nrow=2,widths = 10,heights = 8)
```
...
ggarrange(mitochondrial_gene_expression_per_cell_pre,mitochondrial_gene_expression_per_cell_post,ncol=1,nrow=2,widths = 10,heights = 8)
```
