...
scrna.combined <- RunUMAP(scrna.combined, reduction = "pca", dims = 1:15,verbose=FALSE)
scrna.combined <- FindNeighbors(scrna.combined, reduction = "pca", dims = 1:15,verbose=FALSE)
scrna.combined <- FindClusters(scrna.combined, resolution = 0.5,verbose=FALSE)
rm(scrna.list)
...
final_df <- data.frame(           "cluster"     = scrna.markers$cluster,
                                  ...
                                  "FlyBase_ID" = paste0("<a  href='https://flybase.org/reports/",scrna.markers$geneID,"'>", scrna.markers$geneID,"</a>"))
...
scrna.combined@meta.data$celltype <- Idents(scrna.combined)
# Save the Data
