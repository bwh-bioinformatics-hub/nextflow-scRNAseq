...
if(is.null(params$in_dir)) {
  ...
  scrubletdir      <- params$scrubletdir
...
defined_modalities <- c("scrna", "scatac")
...
```
```{r scrna_cluster_annotation_tab, results = "asis", eval = has_rna, echo = FALSE}
cat("## scRNA Cluster Annotation", sep = "\n")

```            
```{r, child =  system.file("rmarkdown/developmental_donglab_developed_code.rmd", package = "qcreporter"), eval = has_rna}
